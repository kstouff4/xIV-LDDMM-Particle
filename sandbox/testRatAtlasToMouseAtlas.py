...
def main():
    ...
    outpath = (
        "/cis/home/kstouff4/Documents/MeshRegistration/ParticleLDDMMQP/sandbox/AtlasMapping/"
        + alphaSt
        + "/"
    )
    imgSource = "/cis/home/kstouff4/Documents/MeshRegistration/TestImages/Allen_10_anno_16bit_ap.img"
    imgTarg = "/cis/home/kstouff4/Documents/MeshRegistration/TestImages/Rat/WHS_SD_rat_atlas_v4.nii"
    ...
    S, nu_S = gI.makeFromSingleChannelImage(
        ...
        ds=8,
        axEx=[2, 536],
        weights=torch.tensor(0.08**2).type(dtype),
    )
    N = S.shape[0]
    labS = nu_S.shape[-1]
    ...
    T, nu_T = gI.makeFromSingleChannelImage(
        ...
        ds=2,
        axEx=[1, 627],
        weights=torch.tensor(0.078**2).type(dtype),
    )
    labs = nu_T.shape[-1]

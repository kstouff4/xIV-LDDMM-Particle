...
def main():
    ...
    S,nu_S = makeFromSingleChannelImage(b2,0.125,bg=0,ordering=[3,4,5,6,9,10,11,7,8,12,13,14])
    T,nu_T = makeFromSingleChannelImage(b5,0.125,bg=0,ordering=[15,2,3,4,7,9,10,6,14,11,12,13])

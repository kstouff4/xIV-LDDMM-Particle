...
def main():
    ...
    S,nu_S = gi.makeFromSingleChannelImage(b2,0.125*4,bg=0,ordering=[3,4,5,6,9,10,11,8,7,12,13,14],ds=4)
    T,nu_T = gi.makeFromSingleChannelImage(b5,0.125*4,bg=0,ordering=[15,2,3,4,7,9,10,6,14,11,12,13],ds=4)

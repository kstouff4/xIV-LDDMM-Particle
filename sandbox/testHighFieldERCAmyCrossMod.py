...
def main():
    ...
    imgFile = (
        imgPref + "150929/AMYGDALA+ERC+TEC.img"
    ...
    S, nu_S = gI.makeFromSingleChannelImage(
        ...
        ordering=[6],
        ds=2,
        weights=torch.tensor(0.25**3).type(dtype),
    )
    ...
    Dlist, nu_Dlist, nu_DPilist, Glist, nu_Glist = callOptimize(
        S,
        nu_S,
        T,
        nu_T,
    ...
    for t in range(len(Dlist)):
        ...
        vtf.writeVTK(
            ...
            imageValsDPi,
            imageNamesT,
            savedir + "testOutput_Dpi" + str(t) + ".vtk",
            polyData=None,
        )
        vtf.writeVTK(
            G,

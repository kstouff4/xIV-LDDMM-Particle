...
def main():
    ...
    S,nu_S = gI.makeFromSingleChannelImage(b2,0.125*4,bg=0,ordering=[6,2,3,4,7,9,10,11,12,13],ds=4,weights=torch.tensor(0.5**3).type(dtype))
    Sa,nu_Sa = gI.makeFromSingleChannelImage(b2a,0.125*4,bg=0,ordering=[1,2,3,4,5],ds=4,weights=torch.tensor(0.5**3).type(dtype))

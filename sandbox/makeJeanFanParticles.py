...
def main():
    ...
    gNames = ['Ntrk3','Fzd3','Baiap2','Slc17a6','Adora2a','Gpr151','Gabbr2','Cckar','Adgrb3','Lmtk2','Adgrl1','Cx3cl1','Epha4']
    S,nu_S = gI.readSpaceFeatureCSV(fSs,['center_x','center_y'],fSf,gNames,scale=1e-3,labs=labs)

    T,nu_T = gI.readSpaceFeatureCSV(fTs,['center_x','center_y'],fTf,gNames,scale=1e-3,labs=labs)
    ...
    fNames = ['Astrocyte1','Astrocyte2','Astrocyte3','Astrocyte4','Astrocyte5','Cortical_Excitatory_Neuron1','Cortical_Excitatory_Neuron2','Endothelial1','Endothelial2','Ependymal','Excitatory_Granule','Excitatory_Neuron1','Excitatory_Neuron2','Excitatory_Pyramidal1','Excitatory_Pyramidal2','GABAergic_Interneuron1','GABAergic_Interneuron2','GABAergic_ER','Inhibitory_Interneuron','Microglia1','Microglia2','OLs_Neurons','OL_Progenitor1','OL_Progenitor2','OL1','OL2','OL3','OL4','OL5','OL6','Pericyte']
    S,nu_S = gI.readSpaceFeatureCSV(fSs,['center_x','center_y'],fSf,['celllabels'],scale=1e-3,labs=None)

    T,nu_T = gI.readSpaceFeatureCSV(fTs,['center_x','center_y'],fTf,['celllabels'],scale=1e-3,labs=None)

...
def main():
    ...
    listBack = ShootingBackwards(listpq[-1][0],listpq[-1][1],listpq[-1][2],listpq[-1][3],Kg,sigmaRKHS,d,numS,uCoeff,cA,cT,dimE,single)
    ...
    gO.writeVTK(q0n,[w0n],['weights'],dirTest+'test_originalq0.vtk',polyData=None)
    gO.writeVTK(q0n_dup,[w0n_dup],['weights'],dirTest+'test_backwardsShotq0.vtk',polyData=None)
    ...
    gO.writeVTK(qgn,[wgn],['weights'],dirTest+'test_originalqGrid.vtk',polyData=None)
    gO.writeVTK(qgn_dup,[wgn_dup],['weights'],dirTest+'test_backwardsShotqGrid.vtk',polyData=None)
